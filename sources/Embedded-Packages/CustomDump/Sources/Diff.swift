...
///   is detected.
func diff<T>(_ lhs: T, _ rhs: T, format: DiffFormat = .default) -> String? {
...
struct DiffFormat {
  ...
  /// " ").
  static let `default` = Self(first: "-", second: "+", both: " ")
  ...
  static let proportional = Self(first: "\u{2212}", second: "+", both: "\u{2007}")
}
