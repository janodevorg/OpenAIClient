...
*/
typealias ConnectionErrorHandler = (Error) -> ConnectionErrorAction
...
struct MessageEvent: Equatable, Hashable {
     ...
     */
    init(data: String, lastEventId: String = "") {
        self.data = data
...
protocol EventHandler {
    /// If set, the client shuts down the stream when a message matching this stream appears
    var shutdownToken: String? { get }
